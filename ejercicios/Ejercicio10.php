...
<body>
  ...
  <p>Actualice la página para mostrar entre 1 y 10 dados y ver el valor Maximo de puntos.</p>
...
$suma = max($azar1,$azar2,$azar3,$azar4,$azar5,$azar6,$azar7,$azar8,$azar9,$azar10);
